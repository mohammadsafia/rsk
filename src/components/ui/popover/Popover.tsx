import { type ComponentPropsWithoutRef, type ComponentPropsWithRef, type FC, type ReactElement } from 'react';
...
const PopoverContent: FC<PopoverContentProps> = ({ className, align = 'center', sideOffset = 4, ...props }) => (
  <PopoverPrimitive.Portal>
    <PopoverPrimitive.Content
      ...
      className={cn(
        'border-muted-200 bg-popover text-popover-foreground z-50 w-72 rounded-md border p-4 shadow-md outline-none',
