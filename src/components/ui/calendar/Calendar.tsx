...
function CalendarMonthsDropdown({ options, value, onChange, disabled }: DropdownProps) {
...
function CalendarYearsDropdown({ options, value, onChange, disabled }: DropdownProps) {
  if (!options || options.length === 0) return <></>;
